...
char *usmart_get_input_string(void)
{
    ...
    if (usart1Data.rxFlag & 0x8000)        /* 串口接收完成？ */
    {
        len = usart1Data.rxFlag & 0x3fff;  /* 得到此次接收到的数据长度 */
        usart1Data.rxBuffer[len] = '\0';     /* 在末尾加入结束符. */
        pbuf = (char*)usart1Data.rxBuffer;
        usart1Data.rxFlag = 0;             /* 开启下一次接收 */
    }
